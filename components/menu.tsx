	...
	return (
		<div className="fixed bg-bottom-black w-60 h-screen">
			<div className="flex flex-col bg-upper-black p-4 drop-shadow-md w-full  justify-center items-center">
				<div className="flex flex-col rounded-full h-28 w-28 bg-white justify-center items-center overflow-hidden">
					<img className="w-full" src="profile-placeholder.png" alt='profile picture' />
				</div>
